...
/
prompt --application/shared_components/plugins/dynamic_action/com_mike_gough_slide_down
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(39104556328058371775)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'COM.MIKE.GOUGH.SLIDE.DOWN'
...
,p_help_text=>'<p><strong>Slide Down</strong> is an animation effect which slowly slides Down a region or page item. The effect looks much nicer than the built-in Show dynamic action which immediately shows the component.</p>'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(38858741675692221747)
,p_plugin_id=>wwv_flow_api.id(39104556328058371775)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(38858743378116222463)
,p_plugin_attribute_id=>wwv_flow_api.id(38858741675692221747)
,p_display_sequence=>10
,p_display_value=>'fast'
,p_return_value=>'fast'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(38858744180194223092)
,p_plugin_attribute_id=>wwv_flow_api.id(38858741675692221747)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(38858745283657224120)
,p_plugin_attribute_id=>wwv_flow_api.id(38858741675692221747)
